<div id="b-pricp" class="carousel slide" data-ride="carousel">
      ...
      <div class="row">
        ...
        <div class="col-sm-7">
          <div class="carousel-caption  d-md-block">
            <h5 class="tituloba">LOREM IPSUM - DOLOR SIT AMET</h5>
            <p class="text-justify tba">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation</p>
            <div class="botones">
              <a href="#" class="btn btn-primary btn-lg btban">LEER MÁS <i class="fas fa-chevron-right"></i></a>
              <a href="#" class="btn btn-secondary btn-lg btban">CONTÁCTO  <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <a class="carousel-control-prev" href="#b-pricp" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#b-pricp" role="button" data-slide="next">
